#!/bin/bash
# Batch script to continue enriching companies with Twitter data
# Usage: bash scripts/batch-enrich-twitter-continue.sh
...
# Create log file
log_file="twitter-enrichment-continue-$(date +%Y%m%d-%H%M%S).log"
