...
export default function MyCollaborationsNew({ collaborationId }: MyCollaborationsProps = {}) {
                      ...
                      {collab.details && typeof collab.details === 'object' && (
                        <div className="mb-4">
                          ...
                          {collab.collab_type === 'Podcast Guest Appearance' && 'podcast_name' in collab.details && (
                            <div className="mb-2">
                              <p className="text-sm font-medium">Podcast: {(collab.details as any).podcast_name}</p>
                              {'estimated_reach' in collab.details && (collab.details as any).estimated_reach && (
                                <p className="text-xs text-gray-600 mb-1">Audience: {(collab.details as any).estimated_reach}</p>
                              )}
                            </div>
                          )}
                          ...
                          <p className="text-sm text-gray-600 line-clamp-3">
                            {'short_description' in collab.details && (collab.details as any).short_description ? 
