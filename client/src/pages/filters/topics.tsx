...
export default function TopicsFilter() {
  ...
  const toggleFilterEnabled = () => {
    const currentValue = form.getValues("discovery_filter_topics_enabled");
    form.setValue("discovery_filter_topics_enabled", !currentValue);
    ...
    <MobileCheck>
      <div className="container pb-6 min-h-screen">
        <PageHeader
          ...
          subtitle="Filter by collaboration topics"
          backUrl="/filters"
        />
          ...
          <form className="space-y-4 pb-24">
            <Card>
              <CardContent className="p-4 pt-6">
                ...
                {watchedValues.discovery_filter_topics_enabled && 
                 watchedValues.filtered_marketing_topics.length > 0 && (
                  <div className="mt-4">
                    <h4 className="text-sm font-medium mb-2">Selected Topics:</h4>
                    <div className="flex flex-wrap gap-2">
                      {watchedValues.filtered_marketing_topics.map((topic) => (
                        <Badge 
                          key={topic} 
                          variant="outline"
