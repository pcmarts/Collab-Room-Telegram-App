...
- [Collaboration Type Pill Consistency](./collaboration-type-pill-consistency.md) - Implementation of consistent styling for collaboration type pills across components
